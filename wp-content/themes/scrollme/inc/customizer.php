	...
	*/
	...
	$wp_customize->add_section(
	    new Scrollme_Customize_Section_Pro(
	        ...
	        'scrollme-pro',
	        array(
	            'title'    => esc_html__( 'Upgrade To Scrollme Pro', 'scrollme' ),
	            'title1'    => esc_html__( 'Free Vs Pro', 'scrollme' ),
	            'pro_text' => esc_html__( 'Buy Now','scrollme' ),
	            'pro_text1' => esc_html__( 'Compare','scrollme' ),
	            'pro_url'  => 'https://accesspressthemes.com/wordpress-themes/scrollme-pro/',
	            'pro_url1'  => admin_url( 'themes.php?page=scrollme-welcome&section=free_vs_pro'),
	            'priority' => 1,
	        )
	    )
	);
