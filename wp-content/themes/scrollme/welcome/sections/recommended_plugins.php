<?php
	...
	if(!empty($pro_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Pro Plugins', 'scrollme'); ?></h4>
		<p><?php echo esc_html__('Take Advantage of some of our Premium Plugins', 'scrollme'); ?></p>
	...
	if(!empty($free_plugins)) {
		?>
		<h4 class="recomplug-title"><?php echo esc_html__('Free Plugins', 'scrollme'); ?></h4>
		<p><?php echo esc_html__('These Free Plugins might be handy for you.', 'scrollme'); ?></p>
		<div class="recomended-plugin-wrap">
		<?php
